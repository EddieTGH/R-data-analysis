...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, color=binary)) +
  geom_point() + 
  labs(
    x = "Budget (in 2013 $)", 
    y = "Gross revenue (in 2013 $)", 
    title = "Gross revenue vs. budget, by Passing Bechdel Test"
  )
```
...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, size=roi)) +
